...
public class ProjectSummaryServiceTest {
    ...
    public void setUp() {
        ...
        projectSummaryService = new ProjectSummaryService(clientService, projectMapper, roomService, projectService);
    ...
    public void testGetProjectSummary_ReturnsProject() {
        ...
        when(roomService.calculateTotalInventory(project.getRoom().getId())).thenReturn(BigDecimal.valueOf(823.74));
    ...
    public void testGetProjectSummary_EmptyRoom() {
        ...
        ProjectSummaryDTO result = projectSummaryService.getProjectSummary(user.getUsername(), project2.getId());
