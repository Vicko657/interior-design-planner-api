...
public class ProjectControllerTest {
        ...
        void setUp() {
                ...
                projectCreateDTO.setBudget(BigDecimal.valueOf(20000.00));
                ...
                projectCreateDTO.setDueDate(LocalDate.of(2026, 04, 25));
        ...
        void testCreateProject_ValidationFailure() throws Exception {
                ...
                projectCreateDTO2.setBudget(BigDecimal.valueOf(20000.00));
                projectCreateDTO2.setDescription(
                                "Custom wardrobes, soft lighting, and premium fabrics for a hotel-like feel.");
